const quizzes = [ //multiple, true_false, complete
    {
        ...
        questions: [
            {
                type: "complete",
                question: "Artificial Intelligence is concerned with building systems that",
                correctAnswer: "simulate intelligent behavior",
            },
            {
                type: "complete",
                question: "Machine Learning is a subset of AI that learns to make decisions by",
            ...
            {
                type: "complete",
                question: "The goal of Machine Learning is to automatically detect patterns in data and use them to",
                correctAnswer: "predict future outcomes",
            },
            {
                type: "complete",
                question: "A computer program is said to learn from experience E with respect to task T and performance measure",
                correctAnswer: "P if its performance on T, as measured by P, improves with experience E",
            }
        ]
    },
    // {
